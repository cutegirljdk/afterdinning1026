...
/*
 	...
 	DBCP : Database Connection Pool을 정의하는 객체
 	 			 DB Connection을 생성/소멸하는 방식이 아니라 Pool에 미리 생성해놓고 빌려주고 반납받는 동작원리로 시스템 성능 향상을 위해 사용하는 객체
...
public class DataSourceManager {
	...
	//다양한 dbcp 구현체들의 상위 인터페이스 : 어플리케이션과 구체적인 dbcp 구현체와의 결합도를 느슨하게 하기 위해
	...
	private DataSourceManager() {
		...
		dbcp.setMaxTotal(30); // 자신의 환경에 맞게 설정할 수 있다.
		//인스턴스 변수 DataSource type의 지역변수 dbcp 객체를 참조시킨다.
